...
function ShowAnswer({onAskAnother}){
    return(
        <>
            <Routes>
                <Route path={"/correct"} element={<h2>Thats correct!</h2>} />
                <Route path={"/wrong"} element={<h2>Thats wrong</h2>}/>
            </Routes>
            <div>
...
function Quiz() {
    ...
    return(
        <Routes>
            ...
            <Route
                path={"/answer/*"}
                element={<ShowAnser onAskAnother={handleAskAnother} />}
            />
            <Route path={"/question"}
                element={<Question question={question} onClickAnswer={handleClickAnswer}/>}
            />
